...
Per the project methodology W1. Full grid, real numbers, run against the
...
- **Inverse purity moves sharply DOWN as major frame count increases** —
  ...
  the project methodology already cites
...
See the benchmark record and `benchmarks/results.md` for the full
